...
import com.example.renaigu.dctv.settings.CastPreference;
...
public class VideoViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int intWidth = (int) w;
        mVideoView.setLayoutParams(new RelativeLayout.LayoutParams(intWidth, intHeight));


        this.webView = (WebView) findViewById(R.id.webview);
        this.webView.getSettings().setJavaScriptEnabled(true);
        this.webView.loadUrl("https://kiwiirc.com/client/irc.chatrealm.net/?nick=DCtvApp?&theme=mini#chat");
                ...
                if (null != mSelectedMedia) {
                    ...
                    if (mPlaybackState == PlaybackState.PLAYING) {
                        ...
                        try {
                            ...
                            Utils.handleException(VideoViewActivity.this, e);
                        }
                    } else {
                        updateAlbumArt(PlaybackLocation.REMOTE);
                    }
    ...
    private void loadRemoteMedia(int position, boolean autoPlay) {
        mCastManager.startVideoCastControllerActivity(this, mSelectedMedia.toBundle(), position, true);
    }
    ...
    private void setupControlsCallbacks() {
        mVideoView.setOnErrorListener(new OnErrorListener() {
            ...
            public boolean onError(MediaPlayer mp, int what, int extra) {
                ...
                Utils.showErrorDialog(VideoViewActivity.this, msg);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_settings:
                Intent i = new Intent(VideoViewActivity.this, CastPreference.class);
                startActivity(i);
                break;
